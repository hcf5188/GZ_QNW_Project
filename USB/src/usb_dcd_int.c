...
* @retval status
*/
uint8_t USBRxbuff[64] = {0x01,0x09,0x00,0x70,};
...
//      USB_OTG_ReadPacket(pdev,ep->xfer_buff, status.b.bcnt);
		ptrUSBRecBuf = Mem_malloc(64);
		if(ptrUSBRecBuf != NULL)
		{
			USB_OTG_ReadPacket(pdev,ptrUSBRecBuf, status.b.bcnt);
			if(OSQPost(USBRecvQ,ptrUSBRecBuf)!=OS_ERR_NONE)
